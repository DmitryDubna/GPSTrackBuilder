...
//		// temp
//		GPSTrack.equateHeights(trackRev1Ext.getPoints(), trackRev2Ext.getPoints());
...
//		// create new track for revision 2
//		List<GPSTrackPoint> rev2Points = GPSTrack.createTrackPointsWithDeviation(rev1Points,
//								getDateFromControl(spinRev2DateFrom), 
//								getDateFromControl(spinRev2DateTo), 
//								Double.parseDouble(txtMaxRev2Deviation.getText()),
//								(Double)spinHeight.getValue(),
...
//		GPSTrack.interpolateHeights(extRev1Points, extRev2Points);
//		// write track for revision 1 to .gpx-file
//		track.writeGpxFile(txtRev1FileName.getText(), extRev1Points);
//		// write track for revision 2 to .gpx-file
//		track.writeGpxFile(txtRev2FileName.getText(), extRev2Points);
//	}
...
//	// choose file buttons action listener
//	class ChooseFileButtonListener implements ActionListener
//	{
//		private JTextField textField;
//		
//		ChooseFileButtonListener(JTextField textField)
//		{
...
//			fc.setSelectedFile(new File(CommonData.getCurrentDir() + File.separator + textField.getText()));
//			
////			if (btn == btnChooseRev1File)
////				fc.setSelectedFile(new File(getCurrentDir() + File.separator + txtRev1FileName.getText()));
////			else if (btn == btnChooseRev2File)
////				fc.setSelectedFile(new File(getCurrentDir() + File.separator + txtRev2FileName.getText()));
//			
//			// set filter
//			fc.setFileFilter(new FileNameExtensionFilter("GPS eXchange", "gpx"));
//			fc.setAcceptAllFileFilterUsed(false);
...
//			// and save dialog for output files
//			int retVal = (textField == txtSrcFileName) ? fc.showOpenDialog(textField) : fc.showSaveDialog(textField);
////			int retVal = (btn == btnChooseSrcFile) ? fc.showOpenDialog(btn) : fc.showSaveDialog(btn);
//			
//			if (retVal == JFileChooser.APPROVE_OPTION)
//			{
//				// check suffix .gpx
...
//				textField.setText(fileName);
//				
////				if (btn == btnChooseSrcFile)
////					txtSrcFileName.setText(fileName);
////				else if (btn == btnChooseRev1File)
////					txtRev1FileName.setText(fileName);
////				else
////					txtRev2FileName.setText(fileName);
//			}
//		}
//	}
}
